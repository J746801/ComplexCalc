...
7. Please note that I do not have a Mac, so all the MacOS Versions are untested, unsigned and not notarized, so (if it works) your computer may say it might not be safe software and will ask if you still want to open it. Just click "yes" or something (I don't really know anything about Macs because I don't have one).
